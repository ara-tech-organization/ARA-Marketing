  ...
  return (
    <section className="relative py-24 overflow-hidden"
      ...
      <div className="relative max-w-[1100px] mx-auto px-7">
        ...
        <div className="reveal flex flex-nowrap overflow-x-auto gap-0 mb-0 rounded-t-3xl overflow-hidden"
          ...
          {faqs.map(({ tag, color }, i) => {
            ...
            return (
              <button
                ...
                className="flex-1 min-w-[120px] flex flex-col items-center gap-1.5 px-4 py-5 transition-all duration-300 relative"
                style={{
              ...
              >
                ...
                <span className="text-[10.5px] font-bold uppercase tracking-widest whitespace-nowrap transition-colors duration-200"
