  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-28 -right-28 w-[480px] h-[480px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(8,145,178,0.13) 0%, transparent 65%)' }} />
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="text-center mb-10 reveal">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full
            ...
            style={{ background: 'rgba(8,145,178,0.15)', color: '#38bdf8', border: '1px solid rgba(8,145,178,0.28)' }}>
        ...
        <div className="reveal flex flex-col lg:flex-row gap-7 lg:gap-12 items-stretch mb-8">
          ...
          <div className="lg:w-[46%] flex-shrink-0 relative rounded-2xl overflow-hidden"
            style={{ minHeight: 230, boxShadow: '0 20px 56px rgba(0,0,0,0.45), 0 0 0 1px rgba(8,145,178,0.18)' }}>
            <img
              src={swIntroImg}
            ...
            <div className="absolute inset-0"
              style={{ background: 'linear-gradient(135deg, rgba(8,145,178,0.28) 0%, rgba(37,99,235,0.18) 100%)' }} />

            {/* Glass caption */}
            <div className="absolute bottom-4 left-4 right-4 px-4 py-3 rounded-xl"
              style={{ background: 'rgba(3,17,31,0.78)', backdropFilter: 'blur(12px)', border: '1px solid rgba(8,145,178,0.22)' }}>
            ...
            <div className="absolute top-4 right-4 flex items-center gap-2 px-3 py-2 rounded-xl"
              ...
              <Zap size={12} style={{ color: '#0891b2' }} />
              <div>
          ...
          <div className="flex-1 flex flex-col justify-center gap-4">
            ...
            <a
              ...
              style={{
                ...
                boxShadow: '0 6px 20px rgba(8,145,178,0.32)',
              }}
            >
