    ...
    >
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="text-center mb-10 reveal">
          ...
          <h2 className="font-bold leading-tight tracking-tight text-slate-900 mb-3"
        ...
        <div className="reveal flex flex-col lg:flex-row gap-7 lg:gap-12 items-stretch mb-8">
          ...
          <div className="lg:w-[46%] flex-shrink-0 relative rounded-2xl overflow-hidden"
            style={{ minHeight: 230, boxShadow: '0 20px 56px rgba(37,99,235,0.12), 0 0 0 1px #bfdbfe' }}>
            <img
              src={swIntroImg}
        ...
        <div className="reveal grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map(({ icon: Icon, title, desc, color }, i) => (
            <div
              key={title}
              className={`group delay-${i + 1} flex flex-col gap-3 p-5 rounded-2xl bg-white transition-all duration-300 hover:-translate-y-1`}
            ...
            >
              ...
              <div>
                <h4 className="text-[12px] font-bold text-slate-900 mb-1.5 leading-snug">{title}</h4>
