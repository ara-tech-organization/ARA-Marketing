...
const expertise = [
  { icon: Cpu,       label: 'Latest Backend Engines',    color: '#4f46e5', desc: 'Powered by modern backend technologies that ensure your website runs fast, stays secure, and scales effortlessly with your business.' },
  { icon: Layers,    label: 'CMS Platform Integration',  color: '#7c3aed', desc: 'Seamless integration with WordPress, custom CMS, and headless systems for easy, code-free content management.' },
  { icon: RefreshCw, label: 'Real-Time Content Updates', color: '#4f46e5', desc: 'Publish, edit, and update content in real-time without relying on a developer — full control is yours, anytime.' },
  { icon: Palette,   label: 'Modern UI/UX Design',       color: '#7c3aed', desc: 'Stunning, user-friendly interfaces paired with strong backend architecture for an exceptional digital experience.' },
]
  ...
  return (
    <section id="dw-intro" className="relative py-16 sm:py-20 lg:py-24 overflow-hidden"
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ backgroundImage: 'radial-gradient(rgba(79,70,229,0.07) 1.5px, transparent 1.5px)', backgroundSize: '34px 34px' }} />
      <div className="hidden sm:block absolute -top-20 -right-20 w-[380px] h-[380px] rounded-full border border-indigo-200/35 pointer-events-none animate-[spin_30s_linear_infinite]" />
      ...
      <div className="hidden sm:block absolute -bottom-16 -left-16 w-[280px] h-[280px] rounded-full border border-indigo-300/20 pointer-events-none" />
      ...
      <div className="absolute bottom-0 left-0 w-[200px] sm:w-[400px] h-[200px] sm:h-[400px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(196,181,253,0.18) 0%, transparent 65%)' }} />

      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-7">

        {/* ── Header ── */}
        <div className="text-center mb-10 sm:mb-14 reveal">
          <span className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full text-[10px] sm:text-[11px] font-bold uppercase tracking-widest mb-4 sm:mb-5 text-indigo-600 bg-white/80 shadow-sm"
        ...
        <div className="reveal flex flex-col lg:flex-row gap-8 lg:gap-14 items-stretch mb-12 sm:mb-16">
          ...
          <div className="lg:w-[46%] flex-shrink-0 relative rounded-2xl sm:rounded-3xl overflow-hidden"
            style={{ minHeight: 340, boxShadow: '0 24px 60px rgba(79,70,229,0.16)' }}>
            <img
            ...
            <div className="absolute inset-0"
              style={{ background: 'linear-gradient(135deg, rgba(79,70,229,0.22) 0%, rgba(124,58,237,0.18) 100%)' }} />
            <div className="absolute bottom-5 left-5 right-5 px-5 py-4 rounded-2xl"
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-indigo-600 mb-1">Dynamic Web Page Development in Thanjavur</p>
