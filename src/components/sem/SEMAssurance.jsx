...
const promises = [
  ...
  { icon: Headphones,   title: 'Dedicated PPC Campaign Manager',             desc: 'A personal PPC manager assigned to your account with direct communication, proactive updates, and priority campaign support.',                    color: '#0ea5e9' },
  { icon: Activity,     title: 'Real-Time Conversion & Lead Tracking',       desc: 'Full Google Ads and Analytics conversion tracking setup to measure every lead, call, and sale generated by your campaigns in real time.',         color: '#0ea5e9' },
  { icon: Shield,       title: 'ROI-Focused Ad Optimization',                desc: 'Every campaign decision is driven by ROI data — from bid adjustments to ad copy testing — ensuring your budget works as hard as possible.',        color: '#2563eb' },
  { icon: TrendingUp,   title: 'Smart Budget & Bid Management',              desc: 'AI-assisted bid management and smart budget allocation across campaigns to maximize conversions and minimize wasted spend consistently.',          color: '#2563eb' },
  { icon: DollarSign,   title: 'Transparent Reporting & Campaign Insights',  desc: 'No hidden fees, no jargon — clear campaign insights with actionable recommendations delivered every month to keep you fully informed.',           color: '#0ea5e9' },
]
