...
const faqs = [
  ...
  { q: 'What are the benefits of Google Ads for Businesses?',           a: 'Google Ads provides companies with the ability to drive instant traffic, create more leads, improve their online visibility, and reach potential customers based on keywords, interests, and demographics.',                                                                              color: '#2563eb' },
  { q: 'Do you offer PPC Advertising Services in Thanjavur?',           a: 'Yes, we offer professional ppc ads service in Thanjavur, such as Google Search Ads, remarketing campaigns, display advertising, and conversion-focused PPC management.',                                                                                                                  color: '#0ea5e9' },
  { q: 'What kind of Google Ads campaigns do you work on?',             a: 'We manage Search Ads, Display Ads, YouTube Ads, Shopping Ads, remarketing campaigns, and advertising campaigns for local business goals.',                                                                                                                                                color: '#2563eb' },
  { q: 'What are the benefits of YouTube advertising for companies?',   a: 'YouTube Ads help in increasing brand awareness, customer engagement, and lead generation through targeted video campaigns and audience-based advertising strategies.',                                                                                                                     color: '#2563eb' },
  { q: 'Why choose ARA Discover Marketing for Google Ads?',             a: 'We are a trusted search engine marketing service provider in Thanjavur with AI-powered campaign tactics, transparent reporting, audience targeting prowess, and ROI-centric optimisation.',                                                                                               color: '#0ea5e9' },
]
