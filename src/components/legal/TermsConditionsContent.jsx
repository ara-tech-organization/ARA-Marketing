  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><span className="definition-term">Company</span> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Digital Marketing Firm, 67A, Giri Rd, Srinivasapuram, Balaganapathy Nagar, Thanjavur, Tamil Nadu 613009.</li>
        ...
        <li><span className="definition-term">Terms and Conditions</span> (also referred to as "Terms") means these Terms and Conditions that govern Your access to and use of the Service and form the entire agreement between You and the Company regarding the Service.</li>
        <li><span className="definition-term">Third-Party Social Media Service</span> means any services or content provided by a third party that is displayed, included, made available, or linked to through the Service.</li>
        ...
        <li><span className="definition-term">You</span> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
      </ul>
      ...
      <p>
        Your access to and use of the Service is also subject to Our Privacy Policy, which describes how We collect, use, and
        disclose personal information. Please read Our Privacy Policy carefully before using Our Service.
      </p>
      ...
      <p>
        The Service may display, include, make available, or link to content or services provided by a Third-Party Social Media
        Service. A Third-Party Social Media Service is not owned or controlled by the Company, and the Company does not endorse
        or assume responsibility for any Third-Party Social Media Service.
      </p>
      <p>
        You acknowledge and agree that the Company shall not be responsible or liable, directly or indirectly, for any damage or
        loss caused or alleged to be caused by or in connection with Your access to or use of any Third-Party Social Media Service,
        including any content, goods, or services made available through them.
      </p>
      ...
      <p>
        ...
        any provision of these Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually
      ...
      <p>
        ...
        any way related to the use of or inability to use the Service), even if the Company or any supplier has been advised of
      ...
      <p>
        ...
        damages, which means that some of the above limitations may not apply. In these states, each party&apos;s liability will
      ...
      <p>
        ...
        of any kind. To the maximum extent permitted under applicable law, the Company, on its own behalf and on behalf of its
      ...
      <p>
        ...
        warranty of any kind, express or implied: (i) as to the operation or availability of the Service; (ii) that the Service
        will be uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency of any information or content
        provided through the Service; or (iv) that the Service, its servers, the content, or e-mails sent from or on behalf of
        the Company are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.
      </p>
      ...
      <p>
        ...
        shall not affect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor
      ...
      <ul>
        ...
        <li>By visiting this page on our website: <a href="https://discovermarketing.co/contact" target="_blank" rel="noreferrer">https://discovermarketing.co/contact</a></li>
