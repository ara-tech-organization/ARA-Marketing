...
const tabs = [
  ...
  },
  {
    ...
    desc: 'Off-page SEO is crucial for building website authority and boosting search rankings. We offer the best SEO link building services in Thanjavur through ethical backlink building strategies that increase domain credibility. We create quality backlinks in SEO in Thanjavur that increases website authority and trust in search engines. Our off page optimisation in Thanjavur strategies help businesses boost organic rankings and domain strength.',
    tag: 'Authority',
  ...
  },
  {
    ...
    desc: "Technical SEO makes sure your website is crawlable, indexable, loads quickly, is mobile-friendly, and is optimized for search engines. We are a trusted SEO service provider company in Thanjavur, and we ensure websites are up to date with Google's latest technical standards and ranking requirements.",
    tag: 'Performance',
  ...
  },
  {
    ...
    desc: 'Local SEO helps businesses get seen in Google Maps and local search results. We offer local business SEO services in Thanjavur and help local businesses get more local customers. Our local SEO marketing services in Thanjavur can help your business to rank higher in location-based searches. Our SEO services for local businesses in Thanjavur are ideal for restaurants, clinics, educational institutions, retail stores, and service-based businesses.',
    tag: 'Local Growth',
  ...
  },
  {
    ...
    desc: 'With mobile-first indexing becoming essential, businesses need to make sure their websites are optimized for all types of smartphones and tablets. Our mobile SEO in Thanjavur services focus on enhancing mobile usability, loading speed, and mobile search rankings. As one of the best SEO companies in Thanjavur, we assure your website performs seamlessly across all devices.',
    tag: 'Mobile-First',
