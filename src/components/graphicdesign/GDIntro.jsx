        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="relative p-9 h-full flex flex-col justify-between" style={{ minHeight: '260px' }}>
              ...
              <div className="flex items-center gap-3 mt-6">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: 'linear-gradient(135deg, #60a5fa 0%, #3b82f6 100%)', boxShadow: '0 4px 14px rgba(37,99,235,0.3)' }}>
          ...
          <div className="reveal lg:col-span-5 rounded-3xl overflow-hidden relative"
            ...
            <div className="absolute bottom-0 left-0 right-0 px-6 py-5"
              style={{ background: '#f0f9ff', opacity: 1 }}>
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-[14px] font-bold text-slate-800 mb-1.5">Best Graphic Design Company</p>
                  <div className="flex items-center gap-1">
                    {[1,2,3,4,5].map(i => <Star key={i} size={10} className="text-blue-500" fill="#3b82f6" />)}
                    <span className="text-[10px] text-blue-600 font-semibold ml-1">5.0 Rating</span>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-[32px] font-black leading-none text-slate-800">250+</p>
                  <p className="text-[9px] text-blue-600 font-bold uppercase tracking-wide mt-0.5">Brands Built</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-[12.5px] text-slate-500 leading-[1.8]">
          ...
          >
            ...
            <div className="relative">
              <p className="text-[11px] font-bold text-blue-400 uppercase tracking-widest mb-5">Our Impact</p>
              {[
                { num: '500+', label: 'Designs Delivered', color: '#60a5fa' },
                { num: '100+', label: 'Brands Created',    color: '#38bdf8' },
                { num: '98%',  label: 'Client Satisfaction', color: '#60a5fa' },
              ].map(({ num, label, color }) => (
                <div key={label} className="flex items-center justify-between py-3.5 border-b border-white/10 last:border-0">
            ...
            <div className="relative mt-4 flex items-center gap-2 px-3 py-2 rounded-full self-start"
              style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)' }}>
              <Sparkles size={10} className="text-blue-400" />
              <span className="text-[10px] font-bold text-blue-200">Full Brand Packages</span>
            </div>
          </div>
