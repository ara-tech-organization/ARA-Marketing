...
export default function PriceHero() {
  ...
  return (
    <section
      ...
      style={{ background: '#071a36', minHeight: '42vh' }}
    >
      {/* Deep BG orbs */}
      ...
      {/* Central content */}
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 md:px-7 flex flex-col items-center text-center py-8 sm:py-10 md:py-14">
