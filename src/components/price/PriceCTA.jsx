  ...
  return (
    <section className="py-16 sm:py-20 relative overflow-hidden"
      ...
      <div className="relative z-10 max-w-[700px] mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="reveal inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-600/15 text-blue-400
          border border-blue-600/25 rounded-full text-[11px] font-bold uppercase tracking-widest mb-6">
          <MessageSquare size={11} /> Ready to Get Started?
        </div>

        <h2 className="reveal text-[clamp(22px,3vw,36px)] font-bold text-white leading-tight mb-4">
          Not Sure Which Package is Right for You?
        </h2>

        <p className="reveal text-[15px] text-white/55 leading-relaxed mb-8 max-w-[540px] mx-auto">
