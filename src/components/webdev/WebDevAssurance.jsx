...
const assurances = [
  ...
  { icon: Search,     title: 'SEO-Optimized Website Structure',  color: '#0ea5e9', num: '02' },
  { icon: Zap,        title: 'Fast Loading & High Performance',  color: '#2563eb', num: '03' },
  { icon: Shield,     title: 'Secure & Scalable Development',    color: '#0ea5e9', num: '04' },
  { icon: Headphones, title: 'Dedicated Support & Maintenance',  color: '#2563eb', num: '05' },
  { icon: Eye,        title: 'Transparent Development Process',  color: '#0ea5e9', num: '06' },
]
