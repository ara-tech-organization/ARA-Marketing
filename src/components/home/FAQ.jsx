...
const faqs = [
  ...
  { q: 'What services does Ara Discover Marketing offer?',                   a: 'We offer complete SEO services, social media marketing, Google Ads management, branding, advertising, video editing, email marketing, influencer marketing and lead generation solutions.' },
  { q: 'How does SEO benefit local businesses in Thanjavur?',                a: 'SEO increases your website visibility on search engines so local customers can find your business online, resulting in consistent organic traffic and highly qualified leads without ongoing ad spend.' },
  { q: 'Why is Ara Discover Marketing a top branding agency in Thanjavur?',  a: 'We develop effective branding strategies, innovative ad campaigns and strong digital identities, helping businesses build trust, enhance customer engagement and stand out from competitors.' },
  { q: 'What sets Ara Discover Marketing apart from other agencies?',        a: 'Our AI-driven strategies, transparent reporting, customized campaigns, ethical approach and measurable results make us one of the best digital marketing agencies in Thanjavur for long-term business growth.' },
]
