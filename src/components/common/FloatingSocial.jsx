...
const socials = [
  ...
  },
  {
    ...
    gradBg: 'linear-gradient(135deg,#f58529 0%,#dd2a7b 50%,#515bd4 100%)',
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
  ...
  return (
    <>
      <style>{`
        ...
        .fs-wrap {
          animation: fs-slide-in 0.55s cubic-bezier(.34,1.4,.64,1) 1s both;
        }
        @keyframes fs-pulse {
      ...
      >
        {socials.map(({ id, label, href, color, dark, glow, gradBg, svg }) => {
          const isHov = hovered === id
          const btnBg = gradBg || `linear-gradient(135deg,${color},${dark})`
            ...
            <div key={id} className="relative flex items-center">
              ...
              <div
                ...
                style={{
                  right: 'calc(100% + 12px)',
                  top: '50%',
                  transform: isHov ? 'translateY(-50%) translateX(0)' : 'translateY(-50%) translateX(8px)',
                  opacity: isHov ? 1 : 0,
              ...
              <a
                ...
                style={{
                  ...
                  color: '#fff',
                  boxShadow: isHov
                    ? `0 6px 22px ${glow}, 0 0 0 3px ${color}40`
                    : `0 3px 10px ${glow}`,
                  transform: isHov ? 'scale(1.18) translateX(-3px)' : 'scale(1)',
                  transition: 'all 0.22s cubic-bezier(.34,1.4,.64,1)',
                }}
              >
                {svg}
