...
export default function EWCTA() {
  ...
  const inputStyle = { background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.14)', color: '#ffffff' }
  const onFocus = e => { e.target.style.background = 'rgba(255,255,255,0.12)'; e.target.style.borderColor = 'rgba(167,139,250,0.55)'; e.target.style.boxShadow = '0 0 0 3px rgba(124,58,237,0.12)' }
  ...
  return (
    <section id="ew-cta" className="relative py-12 sm:py-16 lg:py-24 overflow-hidden"
      ...
      {/* Orbs — md+ only */}
      <div className="hidden md:block absolute -top-20 -left-20 w-[440px] h-[440px] rounded-full pointer-events-none animate-orb"
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-16 items-start lg:items-center reveal">
          ...
          <div className="w-full lg:w-[46%]">
            <span className="inline-flex items-center gap-1.5 px-3 sm:px-3.5 py-1.5 rounded-full text-[10px] sm:text-[11px] font-bold uppercase tracking-widest mb-4 sm:mb-6"
            ...
            <p className="text-[12.5px] sm:text-[14px] lg:text-[15px] leading-[1.88] mb-5 sm:mb-7" style={{ color: 'rgba(255,255,255,0.45)' }}>
            ...
            <div className="space-y-2 sm:space-y-3 mb-5 sm:mb-7">
              {[
                ...
                <div key={pt} className="flex items-center gap-2.5 sm:gap-3">
                  ...
                  <span className="text-[12px] sm:text-[13px] font-medium" style={{ color: 'rgba(255,255,255,0.65)' }}>{pt}</span>
                </div>
              ))}
            </div>
            ...
            <a href="tel:+919876543210"
              ...
              <div className="flex-1">
                <p className="text-[9.5px] sm:text-[10px] font-bold uppercase tracking-wider" style={{ color: 'rgba(255,255,255,0.40)' }}>Call Us Directly</p>
              ...
              {sent ? (
                ...
                <form onSubmit={submit} className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <div className="flex-1">
                      <label className="block text-[10px] sm:text-[11px] font-bold uppercase tracking-wider mb-1 sm:mb-1.5" style={{ color: 'rgba(255,255,255,0.38)' }}>Full Name</label>
                    ...
                    <div className="flex-1">
                      <label className="block text-[10px] sm:text-[11px] font-bold uppercase tracking-wider mb-1 sm:mb-1.5" style={{ color: 'rgba(255,255,255,0.38)' }}>Email Address</label>
                  ...
                  <div>
                    <label className="block text-[10px] sm:text-[11px] font-bold uppercase tracking-wider mb-1 sm:mb-1.5" style={{ color: 'rgba(255,255,255,0.38)' }}>Company Name</label>
                    <input name="company" value={form.company} onChange={handle} placeholder="Your Company"
                      className={inputBase} style={inputStyle} onFocus={onFocus} onBlur={onBlur} />
                  </div>

                  <div>
                    <label className="block text-[10px] sm:text-[11px] font-bold uppercase tracking-wider mb-1 sm:mb-1.5" style={{ color: 'rgba(255,255,255,0.38)' }}>Project Details</label>
                  ...
                  <p className="text-center text-[10.5px] sm:text-[11px]" style={{ color: 'rgba(255,255,255,0.28)' }}>
