...
export default function EWProcess() {
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 overflow-hidden" style={{ background: '#f0f9ff' }}>
      ...
      <div
        className="hidden lg:block absolute -top-24 -right-24 w-[340px] h-[340px] rounded-full pointer-events-none"
        style={{ border: '1.5px solid rgba(124,58,237,0.07)', animation: 'spin 60s linear infinite' }}
      />
      <div
        className="hidden lg:block absolute -bottom-20 -left-20 w-[280px] h-[280px] rounded-full pointer-events-none"
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        {/* ── Phase progress tracker — md+ only ── */}
