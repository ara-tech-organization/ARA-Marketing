...
const reasons = [
  ...
  },
  {
    ...
    body: 'Enterprise websites powered by AI for better decision-making, higher user engagement, and intelligent analytics that keep you ahead of the competition.',
    color: '#7c3aed',
  ...
  },
  {
    ...
    body: 'Informed at every milestone — structured sprints, clear communication, and dedicated project management ensuring consistent on-time delivery.',
    color: '#059669',
