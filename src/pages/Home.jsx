...
const homeSchema = {
  ...
  '@graph': [
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'Which is the best digital marketing company in Thanjavur?', acceptedAnswer: { '@type': 'Answer', text: 'Ara Discover Marketing is known as one of the best digital marketing companies in Thanjavur, providing SEO, social media marketing, Google Ads, branding and lead generation services for businesses across all industries.' } },
        { '@type': 'Question', name: 'Why should businesses hire a digital marketing agency in Thanjavur?', acceptedAnswer: { '@type': 'Answer', text: 'Hiring a professional agency helps businesses improve online visibility, attract targeted customers, increase leads and achieve better ROI through strategic campaigns.' } },
        { '@type': 'Question', name: 'What services does Ara Discover Marketing offer?', acceptedAnswer: { '@type': 'Answer', text: 'We offer complete SEO services, social media marketing, Google Ads management, branding, advertising, video editing, email marketing, influencer marketing and lead generation solutions.' } },
        { '@type': 'Question', name: 'How does SEO benefit local businesses in Thanjavur?', acceptedAnswer: { '@type': 'Answer', text: 'SEO increases your website visibility on search engines, so local customers can find your business online, resulting in organic traffic and qualified leads.' } },
